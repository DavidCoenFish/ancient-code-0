...
#ifndef _SceneNodeComponentClientBat_h_
#define _SceneNodeComponentClientBat_h_
...
class SceneNodeComponentClientBat : public SceneNodeComponentClientObjectBase
{
	//typedef
private:
	typedef boost::shared_ptr<GSceneNodeComponentBase> TPointerSceneNodeComponentBase;
	typedef boost::shared_ptr<SceneNodeComponentClientBat> TPointerSceneNodeComponentClientBat;
...
private:
	...
	//constructor
public:
	SceneNodeComponentClientBat(
		ZombieMission& in_parent,
		TPointerSceneNode& in_parentSceneNode,
		const float in_damageFactor
		);
	virtual ~SceneNodeComponentClientBat();
...
#endif //_SceneNodeComponentClientBat_h_
