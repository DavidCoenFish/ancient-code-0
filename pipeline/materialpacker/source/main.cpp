...
{
	mMessage->AddMessage(std::string("MaterialPacker::Run(") + in_sourceXml + ", " + in_destFile + ")");
...
int main(int in_argc, char ** in_argv)
{
	...
	if (3 != in_argc)
	{
		printf( "\nusage:\\MaterialPacker.exe src.xml destFileName.xml\nchange material files into fudge packer xml source\n" ); 
	}
	else
	{
